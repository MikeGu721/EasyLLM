...
chosen_keys = ['engine', 'temperature','max_tokens','top_p','frequency_penalty','presence_penalty','stop']
    ...
    for batch_id, prompt_batch in tqdm.tqdm(
        ...
        while True:
            try:
                ...
                shared_kwargs = {key: sshared_kwargs[key] for key in chosen_keys}
                messages=[
                        {
                            "role": "system",
                ...
                if api == 'chat':
                    ...
                    completion_batch = openai.Completion.create(messages=messages, **shared_kwargs)
